                    ...
                    <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
                        ...
                        <header className="flex items-center justify-between whitespace-nowrap px-0 sm:px-10 py-3">
                            ...
                            <div className="hidden md:flex flex-1 justify-center gap-9">
                                <Link className="text-sm font-medium leading-normal hover:text-[#135bec] dark:text-gray-300 dark:hover:text-[#135bec]" href="#features">About</Link>
                                <Link className="text-sm font-medium leading-normal hover:text-[#135bec] dark:text-gray-300 dark:hover:text-[#135bec]" href="#pricing">Contact</Link>
                            </div>
