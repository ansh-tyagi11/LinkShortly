                ...
                <div className="flex h-screen md:w-64 w-12 shrink-0 flex-col justify-between border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-[#151C2C] p-4">
                    <div className="flex flex-col justify-between gap-4">
                        ...
                        <nav className="flex flex-col justify-items-start gap-2 mt-4">
                            <Link className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-all ${isActive('/home') ? 'bg-linear-to-r from-[#6366F1] to-[#8B5CF6] text-white shadow-md' : 'text-[#0d121b] dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'}`} href="/home">
                            ...
                            <Link className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-all ${isActive('/allLinks') ? 'bg-linear-to-r from-[#6366F1] to-[#8B5CF6] text-white shadow-md' : 'text-[#0d121b] dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'}`} href="/allLinks">
                            ...
                            <Link className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-all ${isActive('/settings') ? 'bg-linear-to-r from-[#6366F1] to-[#8B5CF6] text-white shadow-md' : 'text-[#0d121b] dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'}`} href="/settings">
