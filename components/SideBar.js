...
const SideBar = () => {
    return (
        <aside className="flex w-64 shrink-0 flex-col justify-between border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-[#151C2C] p-4">
            <div className="flex flex-col gap-4">
                ...
                <nav className="flex flex-col gap-2 mt-4">
                    ...
                    <Link className="flex items-center gap-3 px-3 py-2 rounded-lg text-[#0d121b] dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800" href="#">
            ...
            <div className="flex flex-col gap-2">
                <Link className="flex min-w-[84px] w-full cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-[#4F46E5] text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-[#4F46E5]/90" href="/home">
