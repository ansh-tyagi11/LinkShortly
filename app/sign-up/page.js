            ...
            <div className="flex min-h-screen w-full flex-col lg:flex-row">
              ...
              <div className="flex w-full flex-1 items-center justify-center bg-background-light pb-0 py-12 px-4 dark:bg-background-dark sm:px-6 lg:w-1/2 lg:px-8">
                <div className="w-full max-w-md space-y-8">
                  ...
                  <button className="flex w-full min-w-[84px] cursor-pointer items-center justify-center gap-3 overflow-hidden rounded-lg border border-[#dbcfe7] dark:border-[#3a2f44] bg-white dark:bg-[#1f142b] h-14 px-5 text-[#140d1b] dark:text-white text-base font-medium leading-normal tracking-[0.015em] transition-colors duration-200 hover:bg-gray-50 dark:hover:bg-[#2a1c3a] mb-5">
                    <svg
                      className="h-5 w-5"
                      fill="none"
                      viewBox="0 0 48 48"
